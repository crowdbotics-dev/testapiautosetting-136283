"""
Django settings for testapiautosetting_136283 project.
...
ROOT_URLCONF = 'testapiautosetting_136283.urls'
...
WSGI_APPLICATION = 'testapiautosetting_136283.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TestAPIAutoSettings1il0s Support <support@testapiautosetting-136283.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautosetting_136283 API",
    "DESCRIPTION": "API documentation for testapiautosetting_136283 App",
    "VERSION": "v1",
}
